		...
		module Endpoints
			module EVSExpressMailIntl
				...
				def build_e_vs_express_mail_intl_request(xml, options = {})
					...
					xml.tag!('ToPOBoxFlag', options[:e_vs_express_mail_intl_request][:to_po_box_flag] || 'N')
					...
					xml.tag!('ShippingContents') do
						...
						if options[:e_vs_express_mail_intl_request][:item_details].present?
							options[:e_vs_express_mail_intl_request][:item_details].each do |item_detail|
								xml.tag!('ItemDetail') do
									...
									xml.tag!('NetPounds', item_detail[:net_pounds] || 0)
					...
					tag_unless_blank(xml, 'InsuredNumber', options[:e_vs_express_mail_intl_request][:insured_number])
					tag_unless_blank(xml, 'InsuredAmount', options[:e_vs_express_mail_intl_request][:insured_amount])
					tag_unless_blank(xml, 'Postage', options[:e_vs_express_mail_intl_request][:postage])
					xml.tag!('GrossPounds', options[:e_vs_express_mail_intl_request][:gross_pounds])
					xml.tag!('GrossOunces', options[:e_vs_express_mail_intl_request][:gross_ounces])
					xml.tag!('ContentType', options[:e_vs_express_mail_intl_request][:content_type] || 'GIFT')
					tag_unless_blank(xml, 'ContentTypeOther', options[:e_vs_express_mail_intl_request][:content_type_other])
					xml.tag!('Agreement', options[:e_vs_express_mail_intl_request][:agreement] || 'Y')
					tag_unless_blank(xml, 'Comments', options[:e_vs_express_mail_intl_request][:comments])
					tag_unless_blank(xml, 'LicenseNumber', options[:e_vs_express_mail_intl_request][:license_number])
					tag_unless_blank(xml, 'CertificateNumber', options[:e_vs_express_mail_intl_request][:certificate_number])
					tag_unless_blank(xml, 'InvoiceNumber', options[:e_vs_express_mail_intl_request][:invoice_number])
					xml.tag!('ImageType', options[:e_vs_express_mail_intl_request][:image_type] || 'PDF')
					tag_unless_blank(xml, 'ImageLayout', options[:e_vs_express_mail_intl_request][:image_layout])
					tag_unless_blank(xml, 'CustomerRefNo', options[:e_vs_express_mail_intl_request][:customer_ref_no])
					tag_unless_blank(xml, 'CustomerRefNo2', options[:e_vs_express_mail_intl_request][:customer_ref_no2])
					tag_unless_blank(xml, 'POZipCode', options[:e_vs_express_mail_intl_request][:po_zip_code])
					...
					tag_unless_blank(xml, 'Height', options[:e_vs_express_mail_intl_request][:height])
					tag_unless_blank(xml, 'Girth', options[:e_vs_express_mail_intl_request][:girth])

					tag_unless_blank(xml, 'LabelTime', options[:e_vs_express_mail_intl_request][:label_time])
					tag_unless_blank(xml, 'MeterPaymentFlag', options[:e_vs_express_mail_intl_request][:meter_payment_flag])
					tag_unless_blank(xml, 'ActionCode', options[:e_vs_express_mail_intl_request][:action_code])
					tag_unless_blank(xml, 'OptOutOfSPE', options[:e_vs_express_mail_intl_request][:opt_out_of_spe])
					...
					xml.tag!('DestinationRateIndicator', options[:e_vs_express_mail_intl_request][:destination_rate_indicator] || 'N')
					tag_unless_blank(xml, 'MID', options[:e_vs_express_mail_intl_request][:mid])
					tag_unless_blank(xml, 'LogisticsManagerMID', options[:e_vs_express_mail_intl_request][:logistics_manager_mid])
					tag_unless_blank(xml, 'CRID', options[:e_vs_express_mail_intl_request][:crid])
					tag_unless_blank(xml, 'VendorCode', options[:e_vs_express_mail_intl_request][:vendor_code])
					tag_unless_blank(xml, 'VendorProductVersionNumber', options[:e_vs_express_mail_intl_request][:vendor_product_version_number])
					tag_unless_blank(xml, 'ePostageMailerReporting', options[:e_vs_express_mail_intl_request][:e_postage_mailer_reporting])
					tag_unless_blank(xml, 'SenderFirstName', options[:e_vs_express_mail_intl_request][:sender_first_name])
					tag_unless_blank(xml, 'SenderLastName', options[:e_vs_express_mail_intl_request][:sender_last_name])
					tag_unless_blank(xml, 'SenderBusinessName', options[:e_vs_express_mail_intl_request][:sender_business_name])
					tag_unless_blank(xml, 'SenderAddress1', options[:e_vs_express_mail_intl_request][:sender_address1])
					tag_unless_blank(xml, 'SenderCity', options[:e_vs_express_mail_intl_request][:sender_city])
					tag_unless_blank(xml, 'SenderState', options[:e_vs_express_mail_intl_request][:sender_state])
					tag_unless_blank(xml, 'SenderZip5', options[:e_vs_express_mail_intl_request][:sender_zip5])
					tag_unless_blank(xml, 'SenderPhone', options[:e_vs_express_mail_intl_request][:sender_phone])
					tag_unless_blank(xml, 'SenderEmail', options[:e_vs_express_mail_intl_request][:sender_email])
