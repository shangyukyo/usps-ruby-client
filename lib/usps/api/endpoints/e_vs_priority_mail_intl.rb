		...
		module Endpoints
			module EVSPriorityMailIntl
				...
				def build_e_vs_priority_mail_intl_request(xml, options = {})
					...
					xml.tag!('Revision', options[:e_vs_priority_mail_int_request][:revision] || '2')
					xml.tag!('ImageParameters') do
						tag_unless_blank(xml, 'ImageParameter', options[:e_vs_priority_mail_int_request][:image_parameters][:image_parameter] || '4X6LABEL')
					end if options[:e_vs_priority_mail_int_request][:image_parameters].present?

					xml.tag!('FromFirstName', options[:e_vs_priority_mail_int_request][:from_first_name])
					tag_unless_blank(xml, 'FromMiddleInitial', options[:e_vs_priority_mail_int_request][:from_middle_initial])
					xml.tag!('FromLastName', options[:e_vs_priority_mail_int_request][:from_last_name])
					xml.tag!('FromFirm', options[:e_vs_priority_mail_int_request][:from_firm])
					tag_unless_blank(xml, 'FromAddress1', options[:e_vs_priority_mail_int_request][:from_address1])
					xml.tag!('FromAddress2', options[:e_vs_priority_mail_int_request][:from_address2])
					tag_unless_blank(xml, 'FromUrbanization', options[:e_vs_priority_mail_int_request][:from_urbanization])
					xml.tag!('FromCity', options[:e_vs_priority_mail_int_request][:from_city])
					xml.tag!('FromState', options[:e_vs_priority_mail_int_request][:from_state])
					xml.tag!('FromZip5', options[:e_vs_priority_mail_int_request][:from_zip5])
					tag_unless_blank(xml, 'FromZip4', options[:e_vs_priority_mail_int_request][:from_zip4])
					xml.tag!('FromPhone', options[:e_vs_priority_mail_int_request][:from_phone])
					tag_unless_blank(xml, 'FromCustomsReference', options[:e_vs_priority_mail_int_request][:from_customs_reference])
					tag_unless_blank(xml, 'ToName', options[:e_vs_priority_mail_int_request][:to_name])
					xml.tag!('ToFirstName', options[:e_vs_priority_mail_int_request][:to_first_name])
					xml.tag!('ToLastName', options[:e_vs_priority_mail_int_request][:to_last_name])
					xml.tag!('ToFirm', options[:e_vs_priority_mail_int_request][:to_firm])
					tag_unless_blank(xml, 'ToAddress1', options[:e_vs_priority_mail_int_request][:to_address1])
					xml.tag!('ToAddress2', options[:e_vs_priority_mail_int_request][:to_address2])
					tag_unless_blank(xml, 'ToAddress3', options[:e_vs_priority_mail_int_request][:to_address3])
					xml.tag!('ToCity', options[:e_vs_priority_mail_int_request][:to_city])
					tag_unless_blank(xml, 'ToProvince', options[:e_vs_priority_mail_int_request][:to_province])
					xml.tag!('ToCountry', options[:e_vs_priority_mail_int_request][][:to_country])
					xml.tag!('ToPostalCode', options[:e_vs_priority_mail_int_request][:to_postal_code])
					xml.tag!('ToPOBoxFlag', options[:e_vs_priority_mail_int_request][:to_po_box_flag])
					tag_unless_blank(xml, 'ToPhone', options[:e_vs_priority_mail_int_request][:to_phone])
					tag_unless_blank(xml, 'ToFax', options[:e_vs_priority_mail_int_request][:to_fax])
					tag_unless_blank(xml, 'ToEmail', options[:e_vs_priority_mail_int_request][:to_email])
					tag_unless_blank(xml, 'ImportersReferenceNumber', options[:e_vs_priority_mail_int_request][:importers_reference_number])
					tag_unless_blank(xml, 'NonDeliveryOption', options[:e_vs_priority_mail_int_request][:non_delivery_option])
					tag_unless_blank(xml, 'RedirectName', options[:e_vs_priority_mail_int_request][:redirect_name])
					tag_unless_blank(xml, 'RedirectEmail', options[:e_vs_priority_mail_int_request][:redirect_email])
					tag_unless_blank(xml, 'RedirectSMS', options[:e_vs_priority_mail_int_request][:redirect_sms])
					tag_unless_blank(xml, 'RedirectAddress', options[:e_vs_priority_mail_int_request][:redirect_address])
					tag_unless_blank(xml, 'RedirectCity', options[:e_vs_priority_mail_int_request][:redirect_city])
					tag_unless_blank(xml, 'RedirectState', options[:e_vs_priority_mail_int_request][:redirect_state])
					tag_unless_blank(xml, 'RedirectZipCode', options[:e_vs_priority_mail_int_request][:redirect_zip_code])
					tag_unless_blank(xml, 'RedirectZip4', options[:e_vs_priority_mail_int_request][:redirect_zip4])
					tag_unless_blank(xml, 'Container', options[:e_vs_priority_mail_int_request][:container])

					xml.tag!('ShippingContents') do
						if options[:e_vs_priority_mail_int_request][:item_details].present?
							options[:e_vs_priority_mail_int_request][:item_details].each do |item_details|
								xml.tag!('ItemDetail') do
									xml.tag!('Description', item_detail[:description])
									xml.tag!('Quantity', item_details[:quantity])
									xml.tag!('Value', item_details[:value])
									xml.tag!('NetPounds', item_details[:net_pounds])
									xml.tag!('NetOunces', item_details[:net_ounces])
									xml.tag!('HSTariffNumber', item_details[:hs_tariff_number])
									xml.tag!('CountryOfOrigin', item_details[:country_of_origin])
								end 
							end
						end
					end

					tag_unless_blank(xml, 'Insured', options[:e_vs_priority_mail_int_request][:insured])
					tag_unless_blank(xml, 'InsuredNumber', options[:e_vs_priority_mail_int_request][:insured_number])
					tag_unless_blank(xml, 'InsuredAmount', options[:e_vs_priority_mail_int_request][:insured_amount])
					tag_unless_blank(xml, 'Postage', options[:e_vs_priority_mail_int_request][:postage])
					xml.tag!('GrossPounds', options[:e_vs_priority_mail_int_request][:gross_pounds])
					xml.tag!('GrossOunces', options[:e_vs_priority_mail_int_request][:gross_ounces])
					xml.tag!('ContentType', options[:e_vs_priority_mail_int_request][:content_type] || 'GIFT')
					tag_unless_blank(xml, 'ContentTypeOther', options[:e_vs_priority_mail_int_request][:content_type_other])
					xml.tag!('Agreement', options[:e_vs_priority_mail_int_request][:agreement] || 'Y')
					tag_unless_blank(xml, 'Comments', options[:e_vs_priority_mail_int_request][:comments])
					tag_unless_blank(xml, 'LicenseNumber', options[:e_vs_priority_mail_int_request][:license_number])
					tag_unless_blank(xml, 'CertificateNumber', options[:e_vs_priority_mail_int_request][:certificate_number])
					tag_unless_blank(xml, 'InvoiceNumber', options[:e_vs_priority_mail_int_request][:invoice_number])
					xml.tag!('ImageType', options[:e_vs_priority_mail_int_request][:image_type] || 'PDF')
					tag_unless_blank(xml, 'ImageLayout', options[:e_vs_priority_mail_int_request][:image_layout])
					tag_unless_blank(xml, 'CustomerRefNo', options[:e_vs_priority_mail_int_request][:customer_ref_no])
					tag_unless_blank(xml, 'CustomerRefNo2', options[:e_vs_priority_mail_int_request][:customer_ref_no2])
					tag_unless_blank(xml, 'POZipCode', options[:e_vs_priority_mail_int_request][:po_zip_code])
					tag_unless_blank(xml, 'LabelDate', options[:e_vs_priority_mail_int_request][:label_date])
					tag_unless_blank(xml, 'HoldForManifest', options[:e_vs_priority_mail_int_request][:hold_for_manifest])
					tag_unless_blank(xml, 'EELPFC', options[:e_vs_priority_mail_int_request][:eelpfc])
					tag_unless_blank(xml, 'PriceOptions', options[:e_vs_priority_mail_int_request][:price_options])
					tag_unless_blank(xml, 'Length', options[:e_vs_priority_mail_int_request][:length])
					tag_unless_blank(xml, 'Width', options[:e_vs_priority_mail_int_request][:width])
					tag_unless_blank(xml, 'Height', options[:e_vs_priority_mail_int_request][:height])
					tag_unless_blank(xml, 'Girth', options[:e_vs_priority_mail_int_request][:girth])
					xml.tag!('ExtraServices') do
						tag_unless_blank(xml, 'ExtraService', options[:e_vs_priority_mail_int_request][:extra_services][:extra_service])
					end if options[:e_vs_priority_mail_int_request][:extra_services][:extra_service].present?

					tag_unless_blank(xml, 'ActionCode', options[:e_vs_priority_mail_int_request][:action_code])
					tag_unless_blank(xml, 'OptOutOfSPE', options[:e_vs_priority_mail_int_request][:opt_out_of_spe])
					tag_unless_blank(xml, 'PermitNumber', options[:e_vs_priority_mail_int_request][:permit_number])
					tag_unless_blank(xml, 'AccountZipCode', options[:e_vs_priority_mail_int_request][:account_zip_code])
					tag_unless_blank(xml, 'ImportersReferenceType', options[:e_vs_priority_mail_int_request][:importers_reference_type])
					tag_unless_blank(xml, 'ImportersTelephoneNumber', options[:e_vs_priority_mail_int_request][:importers_telephone_number])
					tag_unless_blank(xml, 'ImportersFaxNumber', options[:e_vs_priority_mail_int_request][:importers_fax_number])
					tag_unless_blank(xml, 'ImportersEmail', options[:e_vs_priority_mail_int_request][:importers_email])
					tag_unless_blank(xml, 'Machinable', options[:e_vs_priority_mail_int_request][:machinable])
					xml.tag!('DestinationRateIndicator', options[:e_vs_priority_mail_int_request][:destination_rate_indicator] || 'N')
					tag_unless_blank(xml, 'MID', options[:e_vs_priority_mail_int_request][:mid])
					tag_unless_blank(xml, 'LogisticsManagerMID', options[:e_vs_priority_mail_int_request][:logistics_manager_mid])
					tag_unless_blank(xml, 'CRID', options[:e_vs_priority_mail_int_request][:crid])
					tag_unless_blank(xml, 'VendorCode', options[:e_vs_priority_mail_int_request][:vendor_code])
					tag_unless_blank(xml, 'VendorProductVersionNumber', options[:e_vs_priority_mail_int_request][:vendor_product_version_number])
					tag_unless_blank(xml, 'ePostageMailerReporting', options[:e_vs_priority_mail_int_request][:e_postage_mailer_reporting])
					tag_unless_blank(xml, 'SenderFirstName', options[:e_vs_priority_mail_int_request][:sender_first_name])
					tag_unless_blank(xml, 'SenderLastName', options[:e_vs_priority_mail_int_request][:sender_last_name])
					tag_unless_blank(xml, 'SenderBusinessName', options[:e_vs_priority_mail_int_request][:sender_business_name])
					tag_unless_blank(xml, 'SenderAddress1', options[:e_vs_priority_mail_int_request][:sender_address1])
					tag_unless_blank(xml, 'SenderCity', options[:e_vs_priority_mail_int_request][:sender_city])
					tag_unless_blank(xml, 'SenderState', options[:e_vs_priority_mail_int_request][:sender_state])
					tag_unless_blank(xml, 'SenderZip5', options[:e_vs_priority_mail_int_request][:sender_zip5])
					tag_unless_blank(xml, 'SenderPhone', options[:e_vs_priority_mail_int_request][:sender_phone])
					tag_unless_blank(xml, 'SenderEmail', options[:e_vs_priority_mail_int_request][:sender_email])
					tag_unless_blank(xml, 'ChargebackCode', options[:e_vs_priority_mail_int_request][:chargeback_code])
